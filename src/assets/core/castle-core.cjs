...
var wasmBinaryFile;
  wasmBinaryFile = 'castle-core.wasm';
...
var wasmSourceMapFile = 'castle-core.wasm.map';
if (!isDataURI(wasmBinaryFile)) {
...
var ASM_CONSTS = {
  3670144: function($0, $1) {alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));},  
 ...
 3671656: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 3672645: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 3672738: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 3672807: function() {return screen.width;},  
 3672832: function() {return screen.height;},  
 3672858: function() {return window.innerWidth;},  
 3672888: function() {return window.innerHeight;},  
 3672919: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 3673014: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 3673151: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 3673375: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 3673868: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 3673936: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 3675588: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 3675998: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 3676603: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
 3677083: function($0) {var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; }},  
 3678255: function() {return withBuiltinMalloc(function () { return allocateUTF8(Module['LSAN_OPTIONS'] || 0); });},  
 3678352: function() {var setting = Module['printWithColors']; if (setting != null) { return setting; } else { return ENVIRONMENT_IS_NODE && process.stderr.isTTY; }}
};
function JS_bridgeEvent(cardId,cardIdLen){ Castle.bridgeEvent(UTF8ToString(cardId, cardIdLen)); }
function JS_dataRequest(requestId,url,urlLen){ Castle.dataRequest(requestId, UTF8ToString(url, urlLen)); }
function JS_documentHasFocus(){ return Castle.isFocused ? 1 : 0; }
function JS_getAuthToken(){ if (Castle && Castle.authToken) { return allocate(intArrayFromString(Castle.authToken), ALLOC_NORMAL); } else { return 0; } }
...
function JS_getCreatorUsername(){ if (Castle.creatorUsername) { const result = Castle.creatorUsername; Castle.creatorUsername = null; return allocate(intArrayFromString(result), ALLOC_NORMAL); } else { return 0; }; }
function JS_getDeckId(){ if (Castle.deckId) { return allocate(intArrayFromString(Castle.deckId), ALLOC_NORMAL); } else { return 0; }; }
function JS_getDevicePixelRatio(){ return window.devicePixelRatio; }
function JS_getNextCardSceneData(){ if (Castle.nextCardSceneData) { const result = Castle.nextCardSceneData; Castle.nextCardSceneData = null; return allocate(intArrayFromString(result), ALLOC_NORMAL); } else { return 0; }; }
function JS_getUrl(){ return allocate(intArrayFromString(window.location.href), ALLOC_NORMAL); ; }
function JS_getVariables(){ if (Castle.variables) { const result = Castle.variables; Castle.variables = null; return allocate(intArrayFromString(result), ALLOC_NORMAL); } else { return 0; }; }
function JS_graphqlPostRequest(requestId,body,bodyLen){ Castle.graphqlPostRequest(requestId, UTF8ToString(body, bodyLen)); }
function JS_hasInitialDeck(){ return Castle.hasInitialDeck ? 1 : 0; }
function JS_isDebugEnabled(){ return new URLSearchParams(window.location.search).get("debug") != null; }
function JS_navigateToCardId(cardId,cardIdLen){ Castle.navigateToCardId(UTF8ToString(cardId, cardIdLen)); }
function JS_navigateToDeckId(deckId,deckIdLen){ Castle.navigateToDeckId(UTF8ToString(deckId, deckIdLen)); }
function JS_openDownloadAppLink(){ if (Castle.openDownloadAppLink) { Castle.openDownloadAppLink(); } }
function JS_scriptLog(log,logLen,level,levelLen,blueprintTitle,blueprintTitleLen,count,createdAt){ Castle.scriptLog(UTF8ToString(log, logLen), UTF8ToString(level, levelLen), UTF8ToString(blueprintTitle, blueprintTitleLen), count, createdAt); }
  ...
  var WEBSOCKET = {map:{},nextId:1,allocUTF8FromString:function(str) {
  ...
  function _wsSetErrorCallback(ws, errorCallback) {
          ...
          wasmTable.get(errorCallback) (0, userPointer);
  			};
  ...
  function _wsSetMessageCallback(ws, messageCallback) {
  			...
  			webSocket.onmessage = function(evt) {
  				...
  				if(typeof evt.data == 'string') {
  					...
  					var userPointer = webSocket.rtcUserPointer || 0;
  					wasmTable.get(messageCallback) (pStr, -1, userPointer);
  					_free(pStr);
  				} else {
  					...
  					var userPointer = webSocket.rtcUserPointer || 0;
  					wasmTable.get(messageCallback) (pBuffer, size, userPointer);
  					_free(pBuffer);
  				}
  			};
  			webSocket.onclose = function() {
  				if(webSocket.rtcUserDeleted) return;
  				var userPointer = webSocket.rtcUserPointer || 0;
  				wasmTable.get(messageCallback) (0, 0, userPointer);
  			};
  		}
  ...
  function _wsSetOpenCallback(ws, openCallback) {
  			...
  			var cb = function() {
  				if(webSocket.rtcUserDeleted) return;
  				var userPointer = webSocket.rtcUserPointer || 0;
  				wasmTable.get(openCallback) (userPointer);
  			};
  			webSocket.onopen = cb;
...
var asmLibraryArg = {
  "JS_bridgeEvent": JS_bridgeEvent,
  "JS_dataRequest": JS_dataRequest,
  "JS_documentHasFocus": JS_documentHasFocus,
  "JS_getAuthToken": JS_getAuthToken,
  "JS_getCanvasHeight": JS_getCanvasHeight,
  "JS_getCanvasWidth": JS_getCanvasWidth,
  "JS_getCoreViews": JS_getCoreViews,
  "JS_getCreatorUsername": JS_getCreatorUsername,
  "JS_getDeckId": JS_getDeckId,
  "JS_getDevicePixelRatio": JS_getDevicePixelRatio,
  "JS_getNextCardSceneData": JS_getNextCardSceneData,
  "JS_getUrl": JS_getUrl,
  "JS_getVariables": JS_getVariables,
  "JS_graphqlPostRequest": JS_graphqlPostRequest,
  "JS_hasInitialDeck": JS_hasInitialDeck,
  "JS_isDebugEnabled": JS_isDebugEnabled,
  "JS_navigateToCardId": JS_navigateToCardId,
  "JS_navigateToDeckId": JS_navigateToDeckId,
  "JS_openDownloadAppLink": JS_openDownloadAppLink,
  "JS_scriptLog": JS_scriptLog,
...
/** @type {function(...*):?} */
var _jsNativeEventSend = Module["_jsNativeEventSend"] = createExportWrapper("jsNativeEventSend");

/** @type {function(...*):?} */
var _main = Module["_main"] = createExportWrapper("main");

/** @type {function(...*):?} */
var _jsGraphQLPostRequestComplete = Module["_jsGraphQLPostRequestComplete"] = createExportWrapper("jsGraphQLPostRequestComplete");

/** @type {function(...*):?} */
var _jsDataRequestCompleted = Module["_jsDataRequestCompleted"] = createExportWrapper("jsDataRequestCompleted");
...
var ___heap_base = Module['___heap_base'] = 13694592;
...
if (!Object.getOwnPropertyDescriptor(Module, "WasmSourceMap")) Module["WasmSourceMap"] = function() { abort("'WasmSourceMap' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
...
if (!Object.getOwnPropertyDescriptor(Module, "WEBRTC")) Module["WEBRTC"] = function() { abort("'WEBRTC' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "WEBSOCKET")) Module["WEBSOCKET"] = function() { abort("'WEBSOCKET' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
