...
- Use visible on-screen text. For custom drawing text, read `docs/scripts/drawing-reference.md` and use readable `castle.draw.text(...)` sizes, roughly `7` to `12`; do not use `castle.draw.print(...)`.
