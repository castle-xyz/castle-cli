...
console.log('locating file for wasm: ' + wasmBinaryFile);
...
var tempI64;
var ASM_CONSTS = {
  3541380: function ($0, $1) {
    alert(UTF8ToString($0) + '\n\n' + UTF8ToString($1));
  },
  3541437: function ($0, $1, $2) {
    var w = $0;
    var h = $1;
    var pixels = $2;
...
function JS_bridgeEvent(cardId, cardIdLen) {
  Castle.bridgeEvent(UTF8ToString(cardId, cardIdLen));
}
function JS_dataRequest(requestId, url, urlLen) {
  Castle.dataRequest(requestId, UTF8ToString(url, urlLen));
}
function JS_documentHasFocus() {
  return Castle.isFocused ? 1 : 0;
}
function JS_getAuthToken() {
  if (Castle && Castle.authToken) {
    return allocate(intArrayFromString(Castle.authToken), ALLOC_NORMAL);
  } else {
    return 0;
  }
}
function JS_getCanvasHeight() {
  return document.querySelector('#canvas').getBoundingClientRect().height;
}
function JS_getCanvasWidth() {
  return document.querySelector('#canvas').getBoundingClientRect().width;
}
function JS_getCoreViews() {
  if (Castle && Castle.coreViews) {
    return allocate(intArrayFromString(Castle.coreViews), ALLOC_NORMAL);
  } else {
    return 0;
  }
}
function JS_getCreatorUsername() {
  if (Castle.creatorUsername) {
    const result = Castle.creatorUsername;
    Castle.creatorUsername = null;
    return allocate(intArrayFromString(result), ALLOC_NORMAL);
  } else {
    return 0;
  }
}
function JS_getDeckId() {
  if (Castle.deckId) {
...
function JS_getNextCardSceneData() {
...
function JS_getUrl() {
  return allocate(intArrayFromString(window.location.href), ALLOC_NORMAL);
}
function JS_getVariables() {
  if (Castle.variables) {
...
function JS_graphqlPostRequest(requestId, body, bodyLen) {
  Castle.graphqlPostRequest(requestId, UTF8ToString(body, bodyLen));
}
function JS_isDebugEnabled() {
  return new URLSearchParams(window.location.search).get('debug') != null;
}
function JS_navigateToCardId(cardId, cardIdLen) {
  Castle.navigateToCardId(UTF8ToString(cardId, cardIdLen));
}
function JS_navigateToDeckId(deckId, deckIdLen) {
  Castle.navigateToDeckId(UTF8ToString(deckId, deckIdLen));
}
function JS_openDownloadAppLink() {
  if (Castle.openDownloadAppLink) {
    Castle.openDownloadAppLink();
  }
}
function JS_scriptLog(
  log,
  logLen,
  level,
  levelLen,
  ...
  Castle.scriptLog(
    UTF8ToString(log, logLen),
    UTF8ToString(level, levelLen),
    UTF8ToString(blueprintTitle, blueprintTitleLen),
    count,
    createdAt
  );
}
...
var asmLibraryArg = {
  t: JS_bridgeEvent,
  ke: JS_dataRequest,
  la: JS_documentHasFocus,
  oa: JS_getAuthToken,
  mg: JS_getCanvasHeight,
  xg: JS_getCanvasWidth,
  ra: JS_getCoreViews,
  Sf: JS_getCreatorUsername,
  wf: JS_getDeckId,
  lf: JS_getNextCardSceneData,
  pa: JS_getUrl,
  Hf: JS_getVariables,
  ve: JS_graphqlPostRequest,
  Ca: JS_isDebugEnabled,
  $e: JS_navigateToCardId,
  Qe: JS_navigateToDeckId,
  da: JS_openDownloadAppLink,
  Jc: JS_scriptLog,
  ...
  ja: _emscripten_get_battery_status,
  ...
  Pc: _emscripten_glBindVertexArray,
  ...
  Sc: _emscripten_glBlitFramebuffer,
  ...
  Bg: _emscripten_glDeleteQueriesEXT,
  ...
  Oc: _emscripten_glDeleteVertexArrays,
  ...
  kb: _emscripten_glDrawArraysInstancedARB,
  pd: _emscripten_glDrawArraysInstancedEXT,
  lb: _emscripten_glDrawArraysInstancedNV,
  _c: _emscripten_glDrawBuffers,
  ...
  ib: _emscripten_glDrawElementsInstancedARB,
  jb: _emscripten_glDrawElementsInstancedEXT,
  od: _emscripten_glDrawElementsInstancedNV,
  ld: _emscripten_glDrawRangeElements,
  pf: _emscripten_glEnable,
  of: _emscripten_glEnableVertexAttribArray,
  bd: _emscripten_glEndQuery,
  ...
  kf: _emscripten_glFramebufferRenderbuffer,
  jf: _emscripten_glFramebufferTexture2D,
  Qc: _emscripten_glFramebufferTextureLayer,
  ...
  Nc: _emscripten_glGenVertexArrays,
  og: _emscripten_glGenVertexArraysOES,
  ff: _emscripten_glGenerateMipmap,
  bf: _emscripten_glGetActiveAttrib,
  af: _emscripten_glGetActiveUniform,
  _b: _emscripten_glGetActiveUniformBlockName,
  $b: _emscripten_glGetActiveUniformBlockiv,
  ...
  pb: _emscripten_glGetInternalformativ,
  ...
  $c: _emscripten_glGetQueryObjectuiv,
  tg: _emscripten_glGetQueryObjectuivEXT,
  ad: _emscripten_glGetQueryiv,
  ...
  tb: _emscripten_glInvalidateFramebuffer,
  sb: _emscripten_glInvalidateSubFramebuffer,
  ...
  ub: _emscripten_glProgramParameteri,
  ...
  Rc: _emscripten_glRenderbufferStorageMultisample,
  ...
  Zb: _emscripten_glUniformBlockBinding,
  ...
  Yc: _emscripten_glUniformMatrix3x2fv,
  ...
  vd: _emscripten_glVertexAttrib3fv,
  ud: _emscripten_glVertexAttrib4f,
  td: _emscripten_glVertexAttrib4fv,
  Db: _emscripten_glVertexAttribDivisor,
  ig: _emscripten_glVertexAttribDivisorANGLE,
  mb: _emscripten_glVertexAttribDivisorARB,
  qd: _emscripten_glVertexAttribDivisorEXT,
  ...
  sd: _emscripten_glVertexAttribPointer,
  rd: _emscripten_glViewport,
  ...
  E: _emscripten_set_beforeunload_callback_on_thread,
  ...
  Na: _strftime_l,
  ca: _time,
  Uc: _wsCreateWebSocket,
  p: _wsDeleteWebSocket,
  w: _wsSendMessage,
  mc: _wsSetErrorCallback,
  bc: _wsSetMessageCallback,
  xc: _wsSetOpenCallback,
  Ic: _wsSetUserPointer,
};
var asm = createWasm();
var ___wasm_call_ctors = (Module['___wasm_call_ctors'] = function () {
  return (___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['Fg']).apply(
    null,
    arguments
  );
});
...
var _jsNativeEventSend = (Module['_jsNativeEventSend'] = function () {
  return (_jsNativeEventSend = Module['_jsNativeEventSend'] = Module['asm']['Jg']).apply(
    null,
    arguments
  );
});
var _main = (Module['_main'] = function () {
  return (_main = Module['_main'] = Module['asm']['Kg']).apply(null, arguments);
});
var _jsGraphQLPostRequestComplete = (Module['_jsGraphQLPostRequestComplete'] = function () {
  return (_jsGraphQLPostRequestComplete = Module['_jsGraphQLPostRequestComplete'] =
    Module['asm']['Lg']).apply(null, arguments);
});
var _jsDataRequestCompleted = (Module['_jsDataRequestCompleted'] = function () {
  return (_jsDataRequestCompleted = Module['_jsDataRequestCompleted'] = Module['asm']['Mg']).apply(
    null,
    arguments
  );
});
var ___errno_location = (Module['___errno_location'] = function () {
  return (___errno_location = Module['___errno_location'] = Module['asm']['Ng']).apply(
    null,
    arguments
  );
});
...
var dynCall_viiiji = (Module['dynCall_viiiji'] = function () {
  return (dynCall_viiiji = Module['dynCall_viiiji'] = Module['asm']['Xg']).apply(null, arguments);
});
var dynCall_ji = (Module['dynCall_ji'] = function () {
  return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['Yg']).apply(null, arguments);
});
var dynCall_iij = (Module['dynCall_iij'] = function () {
  return (dynCall_iij = Module['dynCall_iij'] = Module['asm']['Zg']).apply(null, arguments);
});
var dynCall_jiij = (Module['dynCall_jiij'] = function () {
  return (dynCall_jiij = Module['dynCall_jiij'] = Module['asm']['_g']).apply(null, arguments);
});
var dynCall_iiij = (Module['dynCall_iiij'] = function () {
  return (dynCall_iiij = Module['dynCall_iiij'] = Module['asm']['$g']).apply(null, arguments);
});
var dynCall_viiij = (Module['dynCall_viiij'] = function () {
  return (dynCall_viiij = Module['dynCall_viiij'] = Module['asm']['ah']).apply(null, arguments);
});
var dynCall_ij = (Module['dynCall_ij'] = function () {
  return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['bh']).apply(null, arguments);
});
var dynCall_jijii = (Module['dynCall_jijii'] = function () {
  return (dynCall_jijii = Module['dynCall_jijii'] = Module['asm']['ch']).apply(null, arguments);
});
var dynCall_jiji = (Module['dynCall_jiji'] = function () {
  return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['dh']).apply(null, arguments);
});
var dynCall_iiiiij = (Module['dynCall_iiiiij'] = function () {
  return (dynCall_iiiiij = Module['dynCall_iiiiij'] = Module['asm']['eh']).apply(null, arguments);
});
var dynCall_iiiiijj = (Module['dynCall_iiiiijj'] = function () {
  return (dynCall_iiiiijj = Module['dynCall_iiiiijj'] = Module['asm']['fh']).apply(null, arguments);
});
var dynCall_iiiiiijj = (Module['dynCall_iiiiiijj'] = function () {
  return (dynCall_iiiiiijj = Module['dynCall_iiiiiijj'] = Module['asm']['gh']).apply(
    null,
    arguments
  );
});
